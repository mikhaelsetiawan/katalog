...
<?php 
  $forlength = 0;
    $work = $_POST['work'];
    if($work == "software"){$forlength = 8;}
    if($work == "website"){$forlength = 1;}
    if($work == "internet"){$forlength = 5;}
    if($work == "hardware"){$forlength = 5;}
    if($work == "design"){$forlength = 5;}
    if($work == "video"){$forlength = 2;}
  $ctr = 0; 
  $check = 4;
